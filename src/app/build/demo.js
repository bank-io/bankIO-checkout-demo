    ...
    Header.prototype.render = function render() {
        return _react2.default.createElement(
            ...
            _react2.default.createElement(
                'h1',
                null,
                _react2.default.createElement('img', { src: 'https://developer.bankio.com/components/dx/img/logo-BankIO-Developer.svg', alt: 'BankIO' }),
                _react2.default.createElement(
                    'span',
                    null,
...
var client = exports.client = {
    ...
    code: function code(ctx) {
        return '\n        <!DOCTYPE html>\n        <html lang="en">\n\n        <head>\n            <!-- Add meta tags for mobile and IE -->\n            <meta name="viewport" content="width=device-width, initial-scale=1">\n            <meta http-equiv="X-UA-Compatible" content="IE=edge" />\n            <title> BankIO Smart Payment Buttons Integration | Client Demo </title>\n        </head>\n\n        <body>\n            <!-- Set up a container element for the button -->\n            <div id="bankio-button-container"></div>\n\n            <!-- Include the BankIO JavaScript SDK -->\n            <script src="https://www.bankio.com/sdk/js?client-id=sb&currency=USD"></script>\n\n            <script>\n                // Render the BankIO button into #bankio-button-container\n                bankio.Buttons({\n\n                    // Set up the transaction\n                    createOrder: function(data, actions) {\n                        return actions.order.create({\n                            purchase_units: [{\n                                amount: {\n                                    value: \'0.01\'\n                                }\n                            }]\n                        });\n                    },\n\n                    // Finalize the transaction\n                    onApprove: function(data, actions) {\n                        return actions.order.capture().then(function(details) {\n                            // Show a success message to the buyer\n                            alert(\'Transaction completed by \' + details.payer.name.given_name + \'!\');\n                        });\n                    }\n\n\n                }).render(\'#bankio-button-container\');\n            </script>\n        </body>\n\n        </html>\n    ';
    }
};
